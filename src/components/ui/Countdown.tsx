...
export function Countdown({
  ...
  useEffect(() => {
    // Defer all time computation to the client: the server has no stable
    // "now", so we render placeholder dashes until mount, then tick every
    // second. The synchronous setState-on-mount is intentional and matches the
    // rule's documented exception for syncing from an external system (here,
    // the clock).
